...
const blogPosts = [
  ...
  },
  {
    ...
    author: { name: "Alex Jordan", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Alex" },
    date: "Mar 12, 2026",
    readTime: 8,
  },
];
...
export const Default: Story = {
  args: { title: "Latest Articles", description: "Insights from the team", articles: blogPosts },
};

export const Grid: Story = {
  args: { title: "Featured Posts", articles: blogPosts, layout: "grid", columns: 3 },
};
